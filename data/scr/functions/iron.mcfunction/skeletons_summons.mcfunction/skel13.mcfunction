summon skeleton -63 269 166 {Silent:1b,Tags:["room_skeleton","just_summoned"],Invulnerable:1b,PersistenceRequired:1b,HandItems:[{id:"minecraft:bow",Count:1},{}],Attributes:[{Name:"generic.movement_speed",Base:0.0}],DeathLootTable:"minecraft:empty"}
