...
give F1aska yellow_dye{display:{Name:'{"text":"Палка-спасалка","color":"yellow","bold":true}',Lore:['{"text":"ПКМ → подброс вверх","color":"gray"}','{"text":"ЛКМ → откинуть врагов на 30 блоков","color":"gray"}']}} 1
