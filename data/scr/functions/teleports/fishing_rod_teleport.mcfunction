...
summon text_display 16 224 67 {text:'{"text":"Рыбу сюда","color":"yellow","bold":true,"italic":false}',billboard:"center",background:1b,shadow:1b,Tags:["fish_text"]}
...
data modify block 8 222 64 Items set value [{Slot:13b,id:"minecraft:fishing_rod",Count:1b,tag:{display:{Name:'{"text":"Удочка призыва","color":"dark_purple","bold":true,"italic":false}',Lore:['{"text":"ПКМ → водяной торнадо","color":"gray","italic":false}','{"text":"ЛКМ → спавнит рыбу","color":"gray","italic":false}']}}}]
