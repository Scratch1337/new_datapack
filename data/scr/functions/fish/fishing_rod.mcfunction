...
give F1aska fishing_rod{display:{Name:'{"text":"Удочка призыва","color":"dark_purple","bold":true}',Lore:['{"text":"ПКМ → водяной торнадо","color":"gray"}','{"text":"ЛКМ → спавнит рыбу","color":"gray"}']}} 1