...
#PEN1
execute if score PEN1 mobCount matches 0 run execute as @e[type=minecraft:text_display,tag=pen1_display,limit=1] run data modify entity @s text set value '[{"text":"Животных в загоне: ","color":"white"},{"text":"0","color":"gray"},{"text":"/","color":"gray"},{"text":"5","color":"dark_green"}]'
execute if score PEN1 mobCount matches 0 run function scr:lead/pens1/pen0

execute if score PEN1 mobCount matches 1 run execute as @e[type=minecraft:text_display,tag=pen1_display,limit=1] run data modify entity @s text set value '[{"text":"Животных в загоне: ","color":"white"},{"text":"1","color":"red"},{"text":"/","color":"gray"},{"text":"5","color":"dark_green"}]'
execute if score PEN1 mobCount matches 1 if score pen1_trigger memory matches 0 run function scr:lead/pens1/pen1

execute if score PEN1 mobCount matches 2 run execute as @e[type=minecraft:text_display,tag=pen1_display,limit=1] run data modify entity @s text set value '[{"text":"Животных в загоне: ","color":"white"},{"text":"2","color":"gold"},{"text":"/","color":"gray"},{"text":"5","color":"dark_green"}]'
execute if score PEN1 mobCount matches 2 if score pen1_trigger memory matches 1 run function scr:lead/pens1/pen2

execute if score PEN1 mobCount matches 3 run execute as @e[type=minecraft:text_display,tag=pen1_display,limit=1] run data modify entity @s text set value '[{"text":"Животных в загоне: ","color":"white"},{"text":"3","color":"yellow"},{"text":"/","color":"gray"},{"text":"5","color":"dark_green"}]'
execute if score PEN1 mobCount matches 3 if score pen1_trigger memory matches 2 run function scr:lead/pens1/pen3

execute if score PEN1 mobCount matches 4 run execute as @e[type=minecraft:text_display,tag=pen1_display,limit=1] run data modify entity @s text set value '[{"text":"Животных в загоне: ","color":"white"},{"text":"4","color":"green"},{"text":"/","color":"gray"},{"text":"5","color":"dark_green"}]'
...
#PEN2
execute if score PEN2 mobCount matches 0 run execute as @e[type=minecraft:text_display,tag=pen2_display,limit=1] run data modify entity @s text set value '[{"text":"Животных в загоне: ","color":"white"},{"text":"0","color":"gray"},{"text":"/","color":"gray"},{"text":"5","color":"dark_green"}]'
execute if score PEN2 mobCount matches 0 run function scr:lead/pens2/pen0

execute if score PEN2 mobCount matches 1 run execute as @e[type=minecraft:text_display,tag=pen2_display,limit=1] run data modify entity @s text set value '[{"text":"Животных в загоне: ","color":"white"},{"text":"1","color":"red"},{"text":"/","color":"gray"},{"text":"5","color":"dark_green"}]'
execute if score PEN2 mobCount matches 1 if score pen2_trigger memory matches 0 run function scr:lead/pens2/pen1

execute if score PEN2 mobCount matches 2 run execute as @e[type=minecraft:text_display,tag=pen2_display,limit=1] run data modify entity @s text set value '[{"text":"Животных в загоне: ","color":"white"},{"text":"2","color":"gold"},{"text":"/","color":"gray"},{"text":"5","color":"dark_green"}]'
execute if score PEN2 mobCount matches 2 if score pen2_trigger memory matches 1 run function scr:lead/pens2/pen2

execute if score PEN2 mobCount matches 3 run execute as @e[type=minecraft:text_display,tag=pen2_display,limit=1] run data modify entity @s text set value '[{"text":"Животных в загоне: ","color":"white"},{"text":"3","color":"yellow"},{"text":"/","color":"gray"},{"text":"5","color":"dark_green"}]'
execute if score PEN2 mobCount matches 3 if score pen2_trigger memory matches 2 run function scr:lead/pens2/pen3

execute if score PEN2 mobCount matches 4 run execute as @e[type=minecraft:text_display,tag=pen2_display,limit=1] run data modify entity @s text set value '[{"text":"Животных в загоне: ","color":"white"},{"text":"4","color":"green"},{"text":"/","color":"gray"},{"text":"5","color":"dark_green"}]'
...
#PEN3
execute if score PEN3 mobCount matches 0 run execute as @e[type=minecraft:text_display,tag=pen3_display,limit=1] run data modify entity @s text set value '[{"text":"Животных в загоне: ","color":"white"},{"text":"0","color":"gray"},{"text":"/","color":"gray"},{"text":"5","color":"dark_green"}]'
execute if score PEN3 mobCount matches 0 run function scr:lead/pens3/pen0

execute if score PEN3 mobCount matches 1 run execute as @e[type=minecraft:text_display,tag=pen3_display,limit=1] run data modify entity @s text set value '[{"text":"Животных в загоне: ","color":"white"},{"text":"1","color":"red"},{"text":"/","color":"gray"},{"text":"5","color":"dark_green"}]'
execute if score PEN3 mobCount matches 1 if score pen3_trigger memory matches 0 run function scr:lead/pens3/pen1

execute if score PEN3 mobCount matches 2 run execute as @e[type=minecraft:text_display,tag=pen3_display,limit=1] run data modify entity @s text set value '[{"text":"Животных в загоне: ","color":"white"},{"text":"2","color":"gold"},{"text":"/","color":"gray"},{"text":"5","color":"dark_green"}]'
execute if score PEN3 mobCount matches 2 if score pen3_trigger memory matches 1 run function scr:lead/pens3/pen2

execute if score PEN3 mobCount matches 3 run execute as @e[type=minecraft:text_display,tag=pen3_display,limit=1] run data modify entity @s text set value '[{"text":"Животных в загоне: ","color":"white"},{"text":"3","color":"yellow"},{"text":"/","color":"gray"},{"text":"5","color":"dark_green"}]'
execute if score PEN3 mobCount matches 3 if score pen3_trigger memory matches 2 run function scr:lead/pens3/pen3

execute if score PEN3 mobCount matches 4 run execute as @e[type=minecraft:text_display,tag=pen3_display,limit=1] run data modify entity @s text set value '[{"text":"Животных в загоне: ","color":"white"},{"text":"4","color":"green"},{"text":"/","color":"gray"},{"text":"5","color":"dark_green"}]'
...
#PEN4
execute if score PEN4 mobCount matches 0 run execute as @e[type=minecraft:text_display,tag=pen4_display,limit=1] run data modify entity @s text set value '[{"text":"Животных в загоне: ","color":"white"},{"text":"0","color":"gray"},{"text":"/","color":"gray"},{"text":"5","color":"dark_green"}]'
execute if score PEN4 mobCount matches 0 run function scr:lead/pens4/pen0

execute if score PEN4 mobCount matches 1 run execute as @e[type=minecraft:text_display,tag=pen4_display,limit=1] run data modify entity @s text set value '[{"text":"Животных в загоне: ","color":"white"},{"text":"1","color":"red"},{"text":"/","color":"gray"},{"text":"5","color":"dark_green"}]'
execute if score PEN4 mobCount matches 1 if score pen4_trigger memory matches 0 run function scr:lead/pens4/pen1

execute if score PEN4 mobCount matches 2 run execute as @e[type=minecraft:text_display,tag=pen4_display,limit=1] run data modify entity @s text set value '[{"text":"Животных в загоне: ","color":"white"},{"text":"2","color":"gold"},{"text":"/","color":"gray"},{"text":"5","color":"dark_green"}]'
execute if score PEN4 mobCount matches 2 if score pen4_trigger memory matches 1 run function scr:lead/pens4/pen2

execute if score PEN4 mobCount matches 3 run execute as @e[type=minecraft:text_display,tag=pen4_display,limit=1] run data modify entity @s text set value '[{"text":"Животных в загоне: ","color":"white"},{"text":"3","color":"yellow"},{"text":"/","color":"gray"},{"text":"5","color":"dark_green"}]'
execute if score PEN4 mobCount matches 3 if score pen4_trigger memory matches 2 run function scr:lead/pens4/pen3

execute if score PEN4 mobCount matches 4 run execute as @e[type=minecraft:text_display,tag=pen4_display,limit=1] run data modify entity @s text set value '[{"text":"Животных в загоне: ","color":"white"},{"text":"4","color":"green"},{"text":"/","color":"gray"},{"text":"5","color":"dark_green"}]'
